...
export default function AIPaperGenerator() {
  ...
  useEffect(() => {
    try {
      ...
      if (raw) setSavedPapers(JSON.parse(raw));
    } catch (e) {
      console.error(e);
    }
  }, []);
      ...
      {tab === "saved" ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 flex flex-col gap-4">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-md p-8 sm:p-10 min-h-[450px] relative overflow-hidden text-slate-900" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
              {/* Official Watermark */}
